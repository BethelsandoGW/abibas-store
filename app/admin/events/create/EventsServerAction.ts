...
export const eventsCreateData = async (formData: FormData): Promise<{ success: boolean, message: string }> => {
    const validatedForm = eventsFormSchema.safeParse({
...
export async function eventsNameCheck(name: string): Promise<boolean | null> {
