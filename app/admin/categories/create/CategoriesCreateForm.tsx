...
import { categoryCreateData, categoryNameCheck, imagesProcess } from "@/app/admin/categories/create/CategoriesServerAction";
import CategoriesImagesPreview from "@/app/admin/categories/create/CategoriesImagesPreview";
    ...
    useEffect(() => {
        const timeoutId = setTimeout(async () => {
            if (formState.name.value.length > 0) {
                ...
                const checkResult: boolean | null = await categoryNameCheck(formState.name.value);
                if (checkResult === null) {
        ...
        <>
            <div className="w-full min-h-96 mx-auto flex flex-col md:flex-row px-7 gap-y-5 pb-6">
                        ...
                        <p className={
                        ...
                        }>
                            {
                                formState.slug.isFilled === false
                                    ? 'Category slug is required! Unique symbol is allowed'
                                    : ''
                            }
                        </p>
                    </div>
                        ...
                        <p className={
                        ...
                        }>
                            {
                                formState.description.isFilled === false
                                    ? 'Category description is required! Unique symbol is allowed'
                                    : ''
                            }
                        </p>
                    </div>
                ...
                <section
                    ...
                    <CategoriesImagesPreview imagesPreview={imagesCompressed}/>
                </section>
            </div>
        </>
    );
